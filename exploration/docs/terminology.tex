...
\newenvironment{snippet}{
    \VerbatimEnvironment\begin{minted}[frame=lines,framesep=2mm,fontsize=\footnotesize, xleftmargin=0.5em, mathescape, linenos, label=Snippet \arabic{snippet}, labelposition=topline]{julia}}{\end{minted}\addtocounter{snippet}{1}}
...
\begin{minted}[fontsize=\footnotesize,framesep=2mm,escapeinside=||,mathescape=true,frame=lines,linenos]{julia}
...
\begin{minted}[fontsize=\footnotesize,framesep=2mm,escapeinside=||,mathescape=true,frame=lines,linenos,samepage]{julia}
function |$\op^2 a$|(x)
