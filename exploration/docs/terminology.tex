...
\subsection{Higher order AD}

Let us investigate the structure of higher order AD. As an example,
let's explicitly show the structure of $\overleftarrow{\partial} \overleftarrow{\partial} \text{sin}$:
